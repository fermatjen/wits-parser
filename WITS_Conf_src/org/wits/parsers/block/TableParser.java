...
public class TableParser implements WITSParser{
    ...
    public String getProcessedText() {
        ...
        //System.out.println("TABLE IC Invoked");
        ...
        while (true) {
            ...
            if (tableTitleLoc == l_loc) {
                ...
                tableTitle = "Insert Table Title Here";
                ...
                processedTableText = handler.replace(processedTableText, "</para></caution>", "", 0);
                processedTableText = handler.replace(processedTableText, "</para></note>", "", 0);
                //System.out.println("PTABLE:"+processedTableText);
    ...
    public String processTableMarkup(String tableBlock, String tableTitle) {
        ...
        StringHandler handler = new StringHandler();
        handler.setDebugger(debugger);
        //System.out.println(cleanedTableBlock.toString());
        String finalTable = handler.replace(cleanedTableBlock.toString(), "<entry><para><LB>\r\n</para></entry>", "", 0);
        finalTable = handler.replace(finalTable.toString(), "<entry><para> </para></entry>", "", 0);
        finalTable = handler.replace(finalTable.toString(), "<thead><row></row></thead>", "", 0);


        return finalTable;

    //return cleanedTableBlock.toString();
    }
}
