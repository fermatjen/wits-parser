...
public class ParaParser implements WITSParser{
    ...
    public String getProcessedText() {
        ...
        while (true) {
            ...
            if (paraCandidate.indexOf("</WITSTarget>") != -1 || paraCandidate.indexOf("<WITSTarget id=") != -1 || paraCandidate.indexOf("caution>") != -1 || paraCandidate.indexOf("note>") != -1  || paraCandidate.indexOf("tip>") != -1 || paraCandidate.indexOf("<LB>") != -1 || paraCandidate.indexOf("noparse>") != -1 || paraCandidate.trim().equals("") || paraCandidate.indexOf("row>") != -1 || paraCandidate.indexOf("entry>") != -1 || paraCandidate.indexOf("listitem>") != -1 || paraCandidate.indexOf("<sect") != -1 || paraCandidate.indexOf("</sect") != -1 || paraCandidate.indexOf("<informaltable") != -1 || paraCandidate.indexOf("</informaltable") != -1 || paraCandidate.indexOf("itemizedlist>") != -1 || paraCandidate.indexOf("orderedlist>") != -1 || paraCandidate.indexOf("<LB>") != -1 || paraCandidate.startsWith("|") || paraCandidate.endsWith("|") || paraCandidate.indexOf("blockquote>") != -1 || paraCandidate.indexOf("<mediaobject>") != -1) {
