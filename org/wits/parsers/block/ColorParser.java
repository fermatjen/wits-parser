 ...
 * @author FJ
 */
public class ColorParser implements WITSParser{
     ...
     * @param uncleanSGML
     */
    public ColorParser(String uncleanSGML) {
    ...
    public String getProcessedText() {
        ...
        debugger.showDebugMessage("ColorIC", 0, "ColorIC Invoked.");

        int offset = 0;
        StringBuilder _handle = new StringBuilder();

        while (true) {
            int l_loc = uncleanSGML.indexOf("{color:", offset);
            int r_loc = uncleanSGML.indexOf("{color}", l_loc + 1);
        ...
        uncleanSGML = handler.replace(uncleanSGML, "{color}", "");
