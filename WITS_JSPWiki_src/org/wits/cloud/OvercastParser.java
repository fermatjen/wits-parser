...
public class OvercastParser {
    ...
    public String getOvercastContent(String uncleanSGML) {
        ...
        while (true) {
            ...
            //auto detect literal and screen. There could be single line snippet
            //if (overcastText.indexOf("<LB>") == -1) {
            //maybe literal
    ...
    public String getProcessedText() {
        ...
        while (true) {
            ...
            int r_loc = uncleanSGML.indexOf("}}}", l_loc + 3);
            ...
            String overcastText = uncleanSGML.substring(l_loc + 3, r_loc);
        ...
        _handle = new StringBuilder();
        offset = 0;
        //handle literal here. Disable literal parser.
