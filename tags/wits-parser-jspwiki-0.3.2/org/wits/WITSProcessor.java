...
public class WITSProcessor {
    ...
    public String process() {
        ...
        if (inputFile != null) {
            WITSFileReader reader = new WITSFileReader(inputFile);
        ...
        //Process special PIs like %%...%%
        ExtraPIParser PIParser = new ExtraPIParser(uncleanSGML);
        PIParser.setDebugger(debugger);
        uncleanSGML = PIParser.getProcessedText();
        //System.out.println("OVERCAST OP:\r\n"+uncleanSGML);

        if (!isForceParsing) {
            //we support only JSPWiki.
            //System.out.println(uncleanSGML);
            if (uncleanSGML.indexOf("<LB>\r\nh1.") != -1 || uncleanSGML.indexOf("<LB>\r\nh2.") != -1 || uncleanSGML.indexOf("<LB>\r\nh3.") != -1 || uncleanSGML.indexOf("<LB>\r\nh4.") != -1) {
                //maybe confluence text
                //return "ERROR:Alien Wiki Format Detected. Only MediaWiki Markup is Supported!";
                return "ERROR:Confluence Text? " + WITSProperties.WITS_AllienBrandMessage;
            }
            if (uncleanSGML.indexOf("<LB>\r\n==") != -1) {
        ...
        //Remove excess baggage
        //ScriptParser clean for jspwiki. 
        ...
        TermParser termICParser = new TermParser(uncleanSGML);
        termICParser.setDebugger(debugger);
